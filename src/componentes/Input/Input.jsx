const Input = props => {
  ...
  <>   
      ...
      <div class="relative flex justify-center">
          ...
          <input className="block ps-10 py-1 pl-5 dark:bg-dark-200 rounded-full w-full max-w-lg text-gray-900 placeholder:text-gray-900 placeholder:font-bold placeholder:text-xs placeholder:uppercase focus:border-brand-200 focus:border-2 dark:focus:border-brand-100 outline-gray-900" {...props} />
      </div>
  </>
